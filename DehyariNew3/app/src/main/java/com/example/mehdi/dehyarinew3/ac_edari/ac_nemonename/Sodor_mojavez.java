...
public class Sodor_mojavez extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_sodor_mojavez);
        imgShare =findViewById(R.id.imgShare);
        TextViewEx txtViewEx = (TextViewEx) findViewById(R.id.txtMatn);
        txtViewEx.setText(getString(R.string.sodormojavezh), false); // true: enables justification
