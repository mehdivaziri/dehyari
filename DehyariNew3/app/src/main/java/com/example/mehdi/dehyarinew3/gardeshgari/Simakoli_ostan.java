...
public class Simakoli_ostan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_simakoli_ostan);

        imgShare =findViewById(R.id.imgShare);
        TextViewEx txtViewEx = (TextViewEx) findViewById(R.id.txtMatn);
        txtViewEx.setText(getString(R.string.simaostan), false); // true: enables justification
