...
public class Omrani_Atashneshani extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_omrani__atashneshani);
...
// finally change the color
    ...
    private void init() {
        ...
        listGhanon1.setTitle("شیوه نامه جذب نیروهای وظیفه برای پایگاه های آتش نشانی روستایی ");
        mainLists.add(listGhanon1);
        ModelListGhanon listGhanon2=new ModelListGhanon();
        listGhanon2.setTitle("جدول شرایط احراز عناوین شغلی و منابع آموزشی رشته های شغلی آتش نمشانی");
        mainLists.add(listGhanon2);
        ModelListGhanon listGhanon3=new ModelListGhanon();
        listGhanon3.setTitle("فرم تعهد دهیاری");
        mainLists.add(listGhanon3);

        ModelListGhanon listGhanon4=new ModelListGhanon();
        listGhanon4.setTitle("فرو تعهد کارکنان وظیفه");
        mainLists.add(listGhanon4);

        ModelListGhanon listGhanon5=new ModelListGhanon();
        listGhanon5.setTitle("مقررات انضباطی کارکنان وظیفه مامور به خدمت در دستگاههاومراکز دولتی و اجرایی کشور");
        mainLists.add(listGhanon5);

        ModelListGhanon listGhanon6=new ModelListGhanon();
        listGhanon6.setTitle("دستورالعمل البسه");
        mainLists.add(listGhanon6);

        ModelListGhanon listGhanon7=new ModelListGhanon();
        listGhanon7.setTitle("دستورالعمل فعالیت و ادره پایگاه آتش نشانی روستایی");
        mainLists.add(listGhanon7);

        ModelListGhanon listGhanon8=new ModelListGhanon();
        listGhanon8.setTitle("فرم ثبت حوادث و آتش سوزی پایگاه آتش نشانی روستایی");
        mainLists.add(listGhanon8);



        Omrani_Atashnes_Adapter mAdapter = new Omrani_Atashnes_Adapter(mainLists);
        //seting recyclerview
