...
public class Omrani_Aramestan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_omrani__aramestan);
...
// finally change the color
    ...
    private void init() {
        ...
        listGhanon1.setTitle("بازنگری نقشه های غسالخانه روستایی ");
        mainLists.add(listGhanon1);
        ModelListGhanon listGhanon2=new ModelListGhanon();
        listGhanon2.setTitle("شیوه نامه ساخت غسالخانه روستایی");
        mainLists.add(listGhanon2);
        ModelListGhanon listGhanon3=new ModelListGhanon();
        listGhanon3.setTitle("استفتاء از دفتر مقام معظم رهبری");
