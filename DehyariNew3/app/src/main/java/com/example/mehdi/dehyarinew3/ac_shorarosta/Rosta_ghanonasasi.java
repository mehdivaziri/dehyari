package com.example.mehdi.dehyarinew3.ac_shorarosta;
...
public class Rosta_ghanonasasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_rosta_ghanonasasi);
        imgShare =findViewById(R.id.imgShare);
        TextViewEx txtViewEx = (TextViewEx) findViewById(R.id.txtMatn);
        txtViewEx.setText(getString(R.string.shoraghanon), false); // true: enables justification
