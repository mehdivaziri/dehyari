...
import com.example.mehdi.dehyarinew3.adapter.Ghanon_sherkat_tavoni_Adapter;
import com.example.mehdi.dehyarinew3.model.ModelListGhanon;

import java.util.ArrayList;
import java.util.List;

public class Act_sherkat_tavoni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_act_sherkat_tavoni);
