...
public class Entekhabat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_entekhabat);
...
// finally change the color
    ...
    private void init() {
        ...
        Entekhbat_Adapter mAdapter = new Entekhbat_Adapter(mainLists);
        //seting recyclerview
