...
public class Site_karbordi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_site_karbordi);
...
// finally change the color
    ...
    private void init() {
        ...
        listGhanon7.setTitle("سامانه اشتغال روستایی");
        mainLists.add(listGhanon7);

        ModelListGhanon listGhanon8=new ModelListGhanon();
        listGhanon8.setTitle("پژوهشهای روستایی");
        ...
        Sitha_karbordi_Adapter mAdapter = new Sitha_karbordi_Adapter(mainLists);
        //seting recyclerview
